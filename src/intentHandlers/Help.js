...
module.exports.process = (event, token) => {
  ...
  const attachments = [
    {
      title:
        "Ask me questions in natural language about JIRA. So far, I support the following types of questions:",
    ...
    },
    {
      fields: [
        ...
        {
          value:
            '_"What\'s (Pouria Sterling || @pxsterling || pxsterling) working on?"_',
          short: true
        },
        {
    ...
    {
      title:
        'Remember to periodically log in to luis.ai and go to "Review endpoint utterances" to validate new utterances and "Train" Luis.',
      color: "warning"
    },
    {
      text:
        "Make me smarter! Go <https://github.com/agiledigital/poet-bot#adding-functionality|here>",
      color: "warning"
    }
  ];
