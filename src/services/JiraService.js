...
module.exports.issueInfo = issueID => {
  console.log(
    "JIRA URL: " + jiraDetails.url + jiraDetails.issue_endpoint + issueID
  );
  return axios
    .get(jiraDetails.url + jiraDetails.issue_endpoint + issueID, {
      auth: {
...
module.exports.assigneeInfo = jql => {
  console.log(
    "JIRA URL: " + jiraDetails.url + jiraDetails.search_endpoint + jql
  );
  return axios
    .get(jiraDetails.url + jiraDetails.search_endpoint, {
      params: {
        jql: jql
      },
      auth: {
...
module.exports.projectInfo = projectKey => {
  console.log(
    "JIRA URL: " + jiraDetails.url + jiraDetails.project_endpoint + projectKey
  );
  return axios
    .get(jiraDetails.url + jiraDetails.project_endpoint + projectKey, {
      auth: {
        username: jiraDetails.name,
        password: jiraDetails.password
      }
...
module.exports.boardInfo = query => {
  console.log(
    "JIRA URL: " + jiraDetails.url + jiraDetails.board_endpoint + query
  );
  return axios
    .get(jiraDetails.url + jiraDetails.board_endpoint + query, {
      auth: {
        username: jiraDetails.name,
        password: jiraDetails.password
      }
...
module.exports.rapidViewConfigInfo = id => {
  console.log(
    "JIRA URL: " + jiraDetails.url + jiraDetails.rapidview_endpoint + id
  );
  return axios
    .get(jiraDetails.url + jiraDetails.rapidview_endpoint + id, {
      auth: {
        username: jiraDetails.name,
        password: jiraDetails.password
      }
...
module.exports.reportsInfo = id => {
  console.log(
    "JIRA URL: " + jiraDetails.url + jiraDetails.report_endpoint + id
  );
  return axios
    .get(jiraDetails.url + jiraDetails.report_endpoint + id, {
      auth: {
        username: jiraDetails.name,
        password: jiraDetails.password
      }
